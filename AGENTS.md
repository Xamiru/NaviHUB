...
- Read `HANDOFF.md` when a session starts. Keep it short and replace its rolling status at meaningful milestones and before ending or switching agents; durable rules stay in the mirrored contract and subsystem details stay in `docs/architecture/`.
